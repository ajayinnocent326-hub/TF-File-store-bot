...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8463498457:AAGtuZqpSyE5U7O9Xbqg0wncjovMbyfRkoc")
...
DB_NAME = os.environ.get("DB_NAME", "atv-tamil")
...
PORT = os.environ.get("PORT", "18014")
